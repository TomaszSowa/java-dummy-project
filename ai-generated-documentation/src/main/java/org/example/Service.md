    ...
    - If 'a' is 0:
      - Check the sign of 'b':
        ...
        - Otherwise: 
          ...
          - Check the sign of 'c':
            - If 'c' is positive: Print "b is non-positive, c is positive".
            - Otherwise: Print "a and b are non-positive, c is non-positive".
    - If 'a' is negative:
      - Check the sign of 'b':
        - If 'b' is positive:
          - Check the sign of 'c':
        ...
        - Otherwise: 
          - Print "b is non-positive".
          - Check the sign of 'c':
            - If 'c' is positive: Print "a and b are non-positive, c is positive".
            - Otherwise: Print "a and b are non-positive, c is non-positive".
    - Otherwise: 
...
* The `isEven` method implicitly handles the edge case of zero (0) as it is divisible by 2.
* The `highComplexityMethod` does not explicitly handle any input errors or exceptions. It assumes that the input integers are valid.


**Dependencies and Libraries:**

This code uses standard Java libraries and doesn't rely on any external libraries.
